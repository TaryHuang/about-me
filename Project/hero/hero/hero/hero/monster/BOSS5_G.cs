...
namespace hero
{
    public class BOSS5_G : MONSTER
    {
        ...
        TARY_TIMER FRIED = new TARY_TIMER(1, 400);

        public BOSS5_G(Vector2 loc)
            : base(loc)
        {
            V = new TARY_VIMG(GamePage.picBOSS5_G, loc);
            V.stop();
        ...
        public virtual void setTarget()
        {
            ...
            RunTime += GamePage.randObj.Next(0, 10);
        }
